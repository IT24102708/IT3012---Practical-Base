...
class VisualGridHuntGame:
    ...
    def get_percept(self) -> dict:
        ...
        # Determine the cell directly ahead based on current facing direction
        ...
        # Check if the calculated 'ahead' cell is a wall or out of bounds
        wall_ahead = (ahead_x, ahead_y) in self.walls or \
...
class GridGameGUI:
    ...
    def draw_grid(self):
        ...
        for tx, ty in self.env.toxic_traps:
            ...
            # Rendering custom purple shapes (ovals) for the traps
            self.canvas.create_oval(x1, y1, x1 + self.cell_size * 0.5, y1 + self.cell_size * 0.5, fill="#a855f7",
                                    outline="#7e22ce")
